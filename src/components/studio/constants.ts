import { PRINT_COLOR_PALETTE } from "@/lib/constants/print-color-palette";

export const COLOR_PRESETS = PRINT_COLOR_PALETTE;
...
export const FONT_LIST = [
  ...
  { label: "나눔손글씨 붓", family: "'Nanum Brush Script'", category: "붓글씨·손글씨" },
  { label: "나눔손글씨 펜", family: "'Nanum Pen Script'", category: "붓글씨·손글씨" },
  { label: "동해독도 (붓)", family: "'East Sea Dokdo'", category: "붓글씨·손글씨" },
  { label: "송명 (붓 명조)", family: "'Song Myung'", category: "붓글씨·손글씨" },
  { label: "개구 (손글씨)", family: "'Gaegu'", category: "붓글씨·손글씨" },
